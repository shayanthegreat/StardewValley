...
public class RefrigeratorPopUp extends PopUpMenu {

    private Table itemsTable;

    public RefrigeratorPopUp(Stage stage) {
        super(stage);
        createPopupMenu();
    }
    ...
    protected void createPopupMenu() {
        ...
        popupWindow.getTitleLabel().setText("Refrigerator");
    ...
    private void refreshBackPackList() {
        ...
        HashMap<Item, Integer> backpack =  player.getFarm().getHouse().getRefrigerator().getItems();
        ...
        for (Item item : backpack.keySet()) {
            ...
            button.addListener(new ClickListener() {
                ...
                public void clicked(InputEvent event, float x, float y) {
                    HouseController.getInstance().refrigerator(item.getName(), false);
                    hide();
